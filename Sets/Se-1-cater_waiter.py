...
from sets_categories_data import (VEGAN,           # type: ignore
                                  VEGETARIAN,
                                  KETO,
                                  PALEO,
                                  OMNIVORE,
...
def clean_ingredients(dish_name, dish_ingredients):
    ...
    dedup_ingredients = set(dish_ingredients)
    return (dish_name, dedup_ingredients)
...
def singleton_ingredients(dishes, intersection):
    ...
    single_ingredients = []
    for dish in dishes:
        for ingredients in dish:
            if ingredients not in intersection:
                single_ingredients.append(ingredients)
